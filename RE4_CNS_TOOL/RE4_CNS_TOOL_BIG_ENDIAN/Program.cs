...
namespace RE4_CNS_TOOL_BIG_ENDIAN
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("# RE4 CNS TOOL (BIG ENDIAN)");
            ...
            RE4_CNS_TOOL.MainAction.Continue(args, SimpleEndianBinaryIO.Endianness.BigEndian);
        }
    }
}
